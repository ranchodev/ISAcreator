...
/**
 * Provides a Cell Editor so that a OntologyCombo can exist as an CellEditor in a JTable.
 *
 */
public class OntologyComboCellEditor extends AbstractCellEditor
        implements TableCellEditor {

    private JComboBox comboBox;

    public OntologyComboCellEditor(JComboBox comboBox) {
        ...
        comboBox.setRenderer(new OntologyComboCellRenderer());
    ...
    public boolean stopCellEditing() {
        ...
        if (comboBox.getSelectedItem() != null) {
            OntologyTerm term = (OntologyTerm) comboBox.getSelectedItem();
            OntologyManager.addToOntologyTerms(term.toString(), term);
        }
        return true;
    }
     ...
     *
     * @param data - new Contents for the ComboBox.
     */
    public void updateComboBoxContents(String[] data) {
