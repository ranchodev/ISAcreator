package org.isatools.isacreator.ontologymanager.scigraph.io;
...
public class AcceptedOntologiesLoader {
    ...
    private static final String FILE = "ProgramData/cache/scigraph-ontology-detail.cache";


    public static void populateAcceptedOntologies() {

        System.out.println("_____populateAcceptedOntologies()____");
        SciGraph4Client client = new SciGraph4Client();
